		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invioces List",
									"targetURL": "#logaliinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaliinvoices-display": {
								"semanticObject": "logaliinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logali.invoices",
									"url": sap.ui.require.toUrl("logali/invoices")
								}
							}
						}
					}
